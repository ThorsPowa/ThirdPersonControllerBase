...
public class EnemyChasingState : EnemyBaseState
{
    ...
    {
        stateMachine.Animator.CrossFadeInFixedTime(LocomotionHash, CrossFadeInDuration);
    ...
    private bool IsInAttackRange()
    {
        ...
        return playerDistanceSquare <= stateMachine.PlayerAttackRange * stateMachine.PlayerAttackRange; 
    }
